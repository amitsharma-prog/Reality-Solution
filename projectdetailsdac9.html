...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=m3m-65th-avenue by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:39 GMT -->
    	...
    	<div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            	<ul class="bc-ul">
                    ...
                    <li><a href="commercial.html">Commercial</a></li>
					<li><a href="#">/</a></li>
                    <li><a href="#" class="activebc">M3M 65th Avenue</a></li>
                </ul>
...
<article class="">
	<div class="container">
        ...
        <div class="row">            
            ...
            <div class="details-header">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h2 class="">M3M 65th Avenue</h2>
					<div class="margin20" ></div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="details">
                        <div class="details center-block">
							<img src="list/m3m-65th-avenue/logo3m3.png" class="project-logo " style="max-width: 200px;"  alt="" />          
						</div>                        
                    </div>
                </div>
				<div class="col-lg-4 col-md-4 col-sm-12">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 f-list">
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	
								<p class=""><i class="far fa-building"></i> Unit Type:- Retail, Office Spaces</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	                		
								<p class=""><i class="fa fa-cubes" aria-hidden="true"></i> Size:- 14 acres</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    <div class="details">
                        <img src="list/m3m-65th-avenue/m3m-65th-banner.jpg" class="project-banner" alt="M3M 65th Avenue" width="100%"  />
                ...
                <div class="col-lg-4 col-md-4 col-sm-12" style="background-color: #e8e8e8;padding: 20px 15px;border-radius: 3px;">
					...
					<div class="margin10"></div>
						...
						<input type="text" required="required" name="project" class="form-control input" value="M3M 65th Avenue" />
		...
		<div class="p-details">
			<div class="col-lg-8 col-md-6 col-sm-12">
				<h3>M3M 65th Avenue Overview</h3>
				<div>
				   <p>Spread over 14 acres M3M 65th Avenue aka City Hub is the blend of European architecture and India style Market. It’s the best ever proposition by M3M ever offered. M3M New Commercial Launch is located in Sector 65, Golf Course Extension Road Gurugram. The location itself is an address, located in the heart of Gurgaon, connected with all the major roads like Sohna Road, Golf Course Road and Gurgaon-Faridabad Expressway. This Hi-Street Retail is surrounded by the very fast evolving and the most premium neighborhood like Nirvana Country, EMAAR Marbella Villas, M3M Golf Estate, IREO Victory Valley, South City 2 and many more. The Gurgaon's biggest commercial hub is comprised of Lower Ground Floor, Upper Ground Floor, First Floor and Second Floor. There are Retail shops on LOWER ground ,Upper Ground and First Floor, and on Second there’ll be a 12 Screen Multiplex leased with country’s trusted brand.
</p><p>What are the key points for a commercial investment?
</p><p>✓ Location, ✓ Price, ✓ Payment Plan, ✓ Returns and Most important ✓ Planning.
</p><p>M3M 65th Avenue is the amalgamation of all the above aspect, whether it is Location, Pricing, Payment Plans or Planning M3M has taken care of all. M3M New Commercial Project is located on Golf Course Extension road and have entries from two sides, surrounded with the premium and luxurious Residential developments like Golf Estate, EMAAR Marbella Villas and many others. As far as the pricing is concerned it’s the cheapest among all and also for first few bookings company is offering huge discount &amp; Offers. In term of Payment Plans 65th Avenue Payment Plans are designed in a way that no investor or an end user can say NO to it. For Upper Ground and first floor one has to only 30% Now and rest on possession. In today’s market everyone is interested in Assured Return Plan. In This Project M3M is offering you Assured Return Plans also in which assured return is of 10% till possession even if you pay 50% of the total amount. And for designing 65th Avenue hired the top class architect and the best in class London based architect for external façade. In all manners it the best pick for a Commercial Investment and for an End-User, looking at the large number of residential societies it’s a win-win situation for business as well</p> 
				</div>
			</div>
						<div class="col-lg-4 col-md-6 col-sm-12">
				<h3><i class="fas fa-map-marker"></i> Location Map</h3>
				<div>
					<img src="list/m3m-65th-avenue/65th-Avenue-Location-Map.jpg" class="site-plan" alt="" />
				...
				<div>
					<img src="list/m3m-65th-avenue/M3M-65th-Avenue-Site-Plan.jpg" class="site-plan" alt="" />
				</div>
			</div>
				...
				<div>
					<ul><li><p>Double height and conventional retail shops
</p></li><li><p>The frontage to host the world’s best brands with high visibility
</p></li><li><p>Efficiently designed floor plans
</p></li><li><p>Entirely pedestrianized plazas / open spaces around the retail outlets
</p></li><li><p>Dedicated branding signage for every retail outlet
</p></li><li><p>Every shop is efficiently designed along large boulevards / open spaces to ensure clear visibility
</p></li><li><p>Wide display area to showcase latest collection on the go
</p></li><li><p>Well planned shops at all level with connecting bridges for maximum accessibility and visibility
</p></li><li><p style="margin-left: 0px;">Multiple anchor stores.</p></li></ul> 
				</div>
			</div>
			        </div>
        </div>
...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=m3m-65th-avenue by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:40 GMT -->
</html>