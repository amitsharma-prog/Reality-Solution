...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=m3m-cosmopolitan by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:34 GMT -->
    	...
    	<div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            	<ul class="bc-ul">
                    ...
                    <li><a href="commercial.html">Commercial</a></li>
					<li><a href="#">/</a></li>
                    <li><a href="#" class="activebc">M3M Cosmopolitan</a></li>
                </ul>
...
<article class="">
	<div class="container">
        ...
        <div class="row">            
            ...
            <div class="details-header">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h2 class="">M3M Cosmopolitan</h2>
					<div class="margin20" ></div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="details">
                        <div class="details center-block">
							<img src="list/m3m-cosmopolitan/logo.png" class="project-logo " style="max-width: 200px;"  alt="" />          
						</div>                        
                    </div>
                </div>
				<div class="col-lg-4 col-md-4 col-sm-12">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 f-list">
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	
								<p class=""><i class="far fa-building"></i> Unit Type:- Retail, F&B and office spaces</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	                		
								<p class=""><i class="fa fa-cubes" aria-hidden="true"></i> Size:- 3 Acres</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
					...
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">
								<p class=""><i class="fa fa-map-marker" aria-hidden="true"></i> Location:- Golf Course Ext. Road, Sector 66 , Gurgaon</p>                        
							</div>                        
						</div>
					</div>
				</div>
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    <div class="details">
                        <img src="list/m3m-cosmopolitan/m3m.jpg" class="project-banner" alt="M3M Cosmopolitan" width="100%"  />
                ...
                <div class="col-lg-4 col-md-4 col-sm-12" style="background-color: #e8e8e8;padding: 20px 15px;border-radius: 3px;">
					...
					<div class="margin10"></div>
						...
						<input type="text" required="required" name="project" class="form-control input" value="M3M Cosmopolitan" />
		...
		<div class="p-details">
			<div class="col-lg-8 col-md-6 col-sm-12">
				<h3>M3M Cosmopolitan Overview</h3>
				<div>
				   <p>M3M Cosmopolitan is an amalgamation of retail, F&amp;B and office spaces. A range of restaurants, restro-bars and lounge, the premium complex houses 350 units which are strategically connected via escalators, sky bridges and elevators. Conceptualized as a new age shopping hub, the sprawling complex has on-board internationally acclaimed brands that spell exclusivity and legacy. The three acres of landscape has retail space on the ground, first and second floors and F&amp;B space on the first, second floors and terrace.
</p><p>Beautiful LED lit palm trees, drive way, water fountains and innovative identification signage boards add touch of glamour and layers of elegance to the shopping experience. M3M Cosmopolitan - The perfect place to head out to for rejuvenation after a hectic day at work!</p> 
				</div>
			</div>
						<div class="col-lg-4 col-md-6 col-sm-12">
				<h3><i class="fas fa-map-marker"></i> Location Map</h3>
				<div>
					<img src="list/m3m-cosmopolitan/m3m-cosmopolitan-location-map.jpg" class="site-plan" alt="" />
				...
				<div>
					<img src="list/m3m-cosmopolitan/2015_01_12_12_31_14.jpg" class="site-plan" alt="" />
				</div>
			</div>
				...
				<div>
					<ul><li><p>First High street retail hub on Golf Course Road Ext
</p></li><li><p>Impeccable Mix of Retail, F&amp;B and Office Space
</p></li><li><p>Wide Boulevards, Schematic Lights, Open landscaped areas
</p></li><li><p>An Architectural wonder to House Best Of the Brands
</p></li><li><p>Catchment comprising High Networth Population</p></li></ul> 
				</div>
			</div>
			        </div>
        </div>
...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=m3m-cosmopolitan by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:35 GMT -->
</html>