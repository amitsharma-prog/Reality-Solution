...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=emaar-digital-greens by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:21 GMT -->
...
<meta name="Description" content="Reality Solution is The Best Real Estate Agency in Gurugram which provide the Residential,Commercial Projects in Gurugram.Best Commercial Projects in Gurugram are providing by Transaction Point at minimal cost.We are the Best Property Dealers In Gurugram which provides Commercial and Residential Projects in Gurugram.">
                        ...
                        <div class="container-fluid" >
                            ...
                            <div class="collapse navbar-collapse" id="myNavbar">
                                ...
                                <ul class="pull-right rera" style="padding: 0px;">
                                	<li><span class="menuno" id="menuNo"><a href="tel:+919911052355"><i class="fa fa-phone-square"></i> +91 9899891133, 9873092221, 8076952087</a></span></li>
                                    <!-- <li>
    	...
    	<div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            	<ul class="bc-ul">
                    ...
                    <li><a href="commercial.html">Commercial</a></li>
					<li><a href="#">/</a></li>
                    <li><a href="#" class="activebc">Emaar Digital Greens</a></li>
                </ul>
            ...
            <div class="details-header">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 f-list">
					...
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">
								<p class=""><i class="fa fa-map-marker" aria-hidden="true"></i> Location:- Sector 61 , Gurgaon</p>                        
							</div>                        
						</div>
					</div>
				</div>
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    <div class="details">
                        <img src="list/emaar-digital-greens/emmar-digital.jpg" class="project-banner" alt="Emaar Digital Greens" width="100%"  />
                ...
                <div class="col-lg-4 col-md-4 col-sm-12" style="background-color: #e8e8e8;padding: 20px 15px;border-radius: 3px;">
					...
					<div class="margin10"></div>
						...
						<input type="text" required="required" name="project" class="form-control input" value="Emaar Digital Greens" />
						<textarea rows="5" placeholder="Enter your message..." name="message" class="form-control"></textarea>                    
						<input type="submit" name="submit-project" value="Submit" class="button" />                     
					</form>
                </div>
            </div>
            <div class="clearfix"></div>
...
access to nearby Hospitals,Schools,Malls within a radius of 1.5 Km.</p> 
	...
	<li>Corporate and IT industry preferred choice</li>
</ul> 
				</div>
			</div>
			        </div>
               ...
               <div class="col-lg-3 col-md-3 col-sm-12">
				...
				<h5 style="border-bottom: none;">CONTACT INFORMATION</h5>
                    <ul>
                        ...
                        <li style="display:inline-block"><a href="tel:+919911052355" style="font-size: 16px;"> +91-9899891133,9873092221,<br>8076952087</a></li>
                    </ul></div>
                ...
                <hr />
                <div class="col-lg-12 col-md-12 col-sm12">
                	<p class="text-center">Copyright &copy; 2019 Reality Solution - Real Estate India - Property - Properties in India - All Rights Reserved.<!--  | Website Powered By --><!--  <a href="http://starworldweb.com/" target="_blank"><img src="images/sww-icon.png" alt="Star World Web"  /></a> --></p>
...
<script type="text/javascript">
    (function () {
        var options = {
            ...
            whatsapp: "+919899891133", // WhatsApp number
            email: "gurgaon40@gmail.com", // Email
            sms: "+919899891133", // Sms phone number
