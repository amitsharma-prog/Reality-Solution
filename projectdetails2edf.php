...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=M3MNewLaunchSector71 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:36 GMT -->
    	...
    	<div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            	<ul class="bc-ul">
                    ...
                    <li><a href="commercial.html">Commercial</a></li>
					<li><a href="#">/</a></li>
                    <li><a href="#" class="activebc">M3M Broadway</a></li>
                </ul>
...
<article class="">
	<div class="container">
        ...
        <div class="row">            
            ...
            <div class="details-header">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h2 class="">M3M Broadway</h2>
					<div class="margin20" ></div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="details">
                        <div class="details center-block">
							<img src="list/M3MNewLaunchSector71/logo%20(1).png" class="project-logo " style="max-width: 200px;"  alt="" />          
						</div>                        
                    </div>
                </div>
				<div class="col-lg-4 col-md-4 col-sm-12">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 f-list">
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	
								<p class=""><i class="far fa-building"></i> Unit Type:- Retail/Office Space/Studio Apartments</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	                		
								<p class=""><i class="fa fa-cubes" aria-hidden="true"></i> Size:- 300 to 10000 Sqft</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	
								<p class=""><i class="fa fa-cubes" aria-hidden="true"></i> Possession:- 2022</p>                       
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">
								<p class=""><i class="fa fa-map-marker" aria-hidden="true"></i> Location:- Sector 71, Gurugarm</p>                        
							</div>                        
						</div>
					</div>
				</div>
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    <div class="details">
                        <img src="list/M3MNewLaunchSector71/New%20Project%20Sector%2071.jpg" class="project-banner" alt="M3M Broadway" width="100%"  />
                ...
                <div class="col-lg-4 col-md-4 col-sm-12" style="background-color: #e8e8e8;padding: 20px 15px;border-radius: 3px;">
					...
					<div class="margin10"></div>
						...
						<input type="text" required="required" name="project" class="form-control input" value="M3M Broadway" />
		...
		<div class="p-details">
			<div class="col-lg-8 col-md-6 col-sm-12">
				<h3>M3M Broadway Overview</h3>
				<div>
				   <p><b>M3M Broadway Gurgaon - Perfectly Sized Commercial Spaces on Golf Course Extension Road!</b> <br>
If you really want to take your commerce to the next level and constantly improve your graph of success, you must move to the most preferred commercial development on Golf Course Extension Road. Welcome to M3M Broadway Gurgaon, a world-class commercial address that will host NCR's most sophisticated brands and groups. As an exclusive, meticulously designed complex, it is soon going to become a celebrated space for retail, office and serviced apartments. <br><br>

M3M Broadway Sector71 Gurgaon perfectly located on Golf Course Extension Road gives you the best connectivity to every corner of Delhi NCR & close proximity to the operational metro station. M3M Broadway gives your business a new identity.<br>
Enjoys excellent arterial connectivity to Dwarka, Manesar, and NCR Well connected to Golf Course Road, Golf Course Extension Road, Sohna Road, and NH8 Direct connectivity from New Delhi, Sohna and Faridabad
</p> 
				</div>
			</div>
						<div class="col-lg-4 col-md-6 col-sm-12">
				...
				<div>
					<img src="list/M3MNewLaunchSector71/location-map.jpg" class="site-plan" alt="" />
				...
				<div>
					<ul>
<li>Perfect mixture of retail stores, food courts, office spaces and serviced apartments</li>
<li>Best for your current and future needs </li>
<li>Best commercial address with business opportunity</li>
<li>Impressive glass facade with wide frontage</li>
<li>Adequate car parking space with best security features</li>
<li>Best commercial address for the big &amp; small players</li>
<li>Every detail is captured to get maximum benefits</li>
<li>It has flexible space you can use it as you want</li>
</ul> 
				</div>
			</div>
			        </div>
