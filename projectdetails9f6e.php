...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=emaar-palm-heights by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:32 GMT -->
    	...
    	<div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            	<ul class="bc-ul">
                    ...
                    <li><a href="residential-projects.html">Residential</a></li>
					<li><a href="#">/</a></li>
                    <li><a href="#" class="activebc">Emaar Palm Heights</a></li>
                </ul>
        ...
        <div class="row">            
            ...
            <div class="details-header">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h2 class="">Emaar Palm Heights</h2>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 f-list">
					...
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	                		
								<p class=""><i class="fa fa-cubes" aria-hidden="true"></i> Size:- 3BHK with Family Lounge</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
					...
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">
								<p class=""><i class="fa fa-map-marker" aria-hidden="true"></i> Location:- Sector 77, Gurgaon</p>                        
							</div>                        
						</div>
					</div>
				</div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12" style="background-color: #e8e8e8;padding: 20px 15px;border-radius: 3px;">
					...
					<div class="margin10"></div>
						...
						<input type="text" required="required" name="project" class="form-control input" value="Emaar Palm Heights" />
