            ...
            <div class="details-header">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12" id="project-width" style="background-color: #e8e8e8;padding: 20px 15px;border-radius: 3px;">
					...
					<div class="margin10"></div>
						...
						<input type="text" required="required" name="project" id="project" class="form-control input" value="Elan Epic" />
						<textarea rows="5" placeholder="Enter your message..." id="message" name="message" class="form-control"></textarea>                    
