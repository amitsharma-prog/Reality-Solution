...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=aipljoycentral by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:43 GMT -->
    	...
    	<div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            	<ul class="bc-ul">
                    ...
                    <li><a href="commercial.html">Commercial</a></li>
					<li><a href="#">/</a></li>
                    <li><a href="#" class="activebc">AIPL Joy Central | Signature Office Space</a></li>
                </ul>
...
<article class="">
	<div class="container">
        ...
        <div class="row">            
            ...
            <div class="details-header">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h2 class="">AIPL Joy Central | Signature Office Space</h2>
					<div class="margin20" ></div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="details">
                        <div class="details center-block">
							<img src="list/aipljoycentral/180007668323.jpg" class="project-logo " style="max-width: 200px;"  alt="" />          
						</div>                        
                    </div>
                </div>
				<div class="col-lg-4 col-md-4 col-sm-12">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    <div class="details">
                        <img src="list/aipljoycentral/joy-central.jpg" class="project-banner" alt="AIPL Joy Central | Signature Office Space" width="100%"  />
                ...
                <div class="col-lg-4 col-md-4 col-sm-12" style="background-color: #e8e8e8;padding: 20px 15px;border-radius: 3px;">
					...
					<div class="margin10"></div>
						...
						<input type="text" required="required" name="project" class="form-control input" value="AIPL Joy Central | Signature Office Space" />
		...
		<div class="p-details">
			<div class="col-lg-8 col-md-6 col-sm-12">
				<h3>AIPL Joy Central | Signature Office Space Overview</h3>
				<div>
				...
				<div>
					<img src="list/aipljoycentral/joy-central-location-map.jpg" class="site-plan" alt="" />
				...
				<div>
					<img src="list/aipljoycentral/location-map-aipl-joy-central.jpg" class="site-plan" alt="" />
				</div>
			</div>
				...
				<div>
					<h3>What will approach the audience in AIPL Joy Central</h3><ul><li><p>A beautiful infrastructure and location which will provide an attractive image to audience's eyes to come at that place.</p></li><li><p>Amazing multiplexes will achieve the attention of movies lovers</p></li><li><p>The big brands of coffee and food will be there to serve you the better. This will force the people to come at that place.</p></li><li><p>If you want to run a food court, then hit there because the entry and exit of will go through the food courts area only.</p></li></ul><h3>Location amenities about AIPL Joy Central</h3><p>This project made its place at the heart of the city in sector 65 Gurgaon. Many residential plans of apartments and porch societies are running here through the big leading brands such as M3M Merlin, Emaar MGF Marbella, Ansal Essencia, IREO Uptown, Bestech Park View Spa Next to name a few.</p><h3>What makes it approachable at AIPL Joy Central</h3><ul><li><p>he first commercial place with the multiplex at this location, because at the entire location of Golf Course Extension Road Gurgaon .there is no multiplex in any commercial project.</p></li><li><p>At the third floor, you will find a 6 screen multiplex with 1200 seats.</p></li><li><p>From 5th to 11th floor, you will get kind of mini business park, furnished and a corporate-style offices space.</p></li><li><p>Have you heard about the new trend double height shops?if no, then let you know that AIPL Joy Central project having this new feature where you will get shops with large height than ordinary shops.</p></li><li><p>This project AIPL Joy Central is going to get the huge attention and growth in coming years.</p></li></ul> 
				</div>
			</div>
			        </div>
        </div>
...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=aipljoycentral by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:44 GMT -->
</html>