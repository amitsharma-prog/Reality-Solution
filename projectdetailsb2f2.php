...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=bptp-centra-one-sec-61-gurgaon by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:28 GMT -->
    	...
    	<div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            	<ul class="bc-ul">
                    ...
                    <li><a href="commercial.html">Commercial</a></li>
					<li><a href="#">/</a></li>
                    <li><a href="#" class="activebc">BPTP Centra One</a></li>
                </ul>
...
<article class="">
	<div class="container">
        ...
        <div class="row">            
            ...
            <div class="details-header">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h2 class="">BPTP Centra One</h2>
					<div class="margin20" ></div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="details">
                        <div class="details center-block">
							<img src="list/bptp-centra-one-sec-61-gurgaon/logo_1533905767.png" class="project-logo " style="max-width: 200px;"  alt="" />          
						</div>                        
                    </div>
                </div>
				<div class="col-lg-4 col-md-4 col-sm-12">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 f-list">
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	
								<p class=""><i class="far fa-building"></i> Unit Type:- Retail and Office Space</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	                		
								<p class=""><i class="fa fa-cubes" aria-hidden="true"></i> Size:- 3.6 Acres</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
					...
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">
								<p class=""><i class="fa fa-map-marker" aria-hidden="true"></i> Location:- Sector 61, Golf Course Extension Road, Gurgaon</p>                        
							</div>                        
						</div>
					</div>
				</div>
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    <div class="details">
                        <img src="list/bptp-centra-one-sec-61-gurgaon/bptp-centra-one.jpg" class="project-banner" alt="BPTP Centra One" width="100%"  />
                ...
                <div class="col-lg-4 col-md-4 col-sm-12" style="background-color: #e8e8e8;padding: 20px 15px;border-radius: 3px;">
					...
					<div class="margin10"></div>
						...
						<input type="text" required="required" name="project" class="form-control input" value="BPTP Centra One" />
		...
		<div class="p-details">
			<div class="col-lg-8 col-md-6 col-sm-12">
				<h3>BPTP Centra One Overview</h3>
				<div>
				   <style type="text/css">
@page { margin: 0.79in }
...
Centra
One, is a high-end commercial complex located on Golf Course
Extension Road in Gurgaon o ering world class modern amenies with
pleasant ambience and excellent connecvvity to the airport.&nbsp;</p><p align="justify">The
center is designed by world renowned architect Cervera &amp; Pioz,
Spain and conforms to modern work environment with facili]es like,
high-speed lis and state of the art security features.</p> 
				</div>
			</div>
						<div class="col-lg-4 col-md-6 col-sm-12">
				<h3><i class="fas fa-map-marker"></i> Location Map</h3>
				<div>
					<img src="list/bptp-centra-one-sec-61-gurgaon/location.jpg" class="site-plan" alt="" />
				...
				<div>
					<img src="list/bptp-centra-one-sec-61-gurgaon/siteplan.jpg" class="site-plan" alt="" />
				</div>
			</div>
				...
				<div>
					<ul>
  <li><p>Centra One is a contemporary and high-tech business complex in Gurgaon's sector 61.</p></li>
    
  <li><p>Strategically located on the 90 metre wide Southern Periphery Road (Golf Course Extension road), Centra One enjoys excellent connectivity to Sohna Road, NH-8 and the Mehrauli-Gurgaon road.</p></li>
    
  <li><p>The complex is designed by world-renowned architects Cervera &amp; Pioz from Spain, and promises to be an integral part of Gurgaon's visual landscape.</p></li>
    
  <li><p>Centra One is designed along modern aesthetics and encompasses dedicated office and retail space. Providing a modern work environment, the complex comes equipped with world-class amenities to create an inspiring and comfortable work sphere.</p></li>
    
  <li><p>With state-of-the-art design aspects and a tranquil ambience, Centra One is an ideal commercial space which enjoys excellent connectivity.</p></li>
    
  <li><p>With a variety of residential and commercial developments coming up in the vicinity, this region has become one of the fastest developing zones in the city and awards Centra One an unmatched value proposition.</p></li>
</ul> 
				</div>
			</div>
			        </div>
...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=bptp-centra-one-sec-61-gurgaon by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:29 GMT -->
</html>