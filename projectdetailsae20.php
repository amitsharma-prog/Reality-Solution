...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=one-horizon-center-gurgaon by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:36 GMT -->
    	...
    	<div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            	<ul class="bc-ul">
                    ...
                    <li><a href="commercial.html">Commercial</a></li>
					<li><a href="#">/</a></li>
                    <li><a href="#" class="activebc">One Horizon Center</a></li>
                </ul>
...
<article class="">
	<div class="container">
        ...
        <div class="row">            
            ...
            <div class="details-header">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h2 class="">One Horizon Center</h2>
					<div class="margin20" ></div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="details">
                        <div class="details center-block">
							<img src="list/one-horizon-center-gurgaon/cont-horizon-center-logo.jpg" class="project-logo " style="max-width: 200px;"  alt="" />          
						</div>                        
                    </div>
                </div>
				<div class="col-lg-4 col-md-4 col-sm-12">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 f-list">
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	
								<p class=""><i class="far fa-building"></i> Unit Type:- Officespace</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	                		
								<p class=""><i class="fa fa-cubes" aria-hidden="true"></i> Size:- 13.80 Acres</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    <div class="details">
                        <img src="list/one-horizon-center-gurgaon/one-horizon-center.jpg" class="project-banner" alt="One Horizon Center" width="100%"  />
                ...
                <div class="col-lg-4 col-md-4 col-sm-12" style="background-color: #e8e8e8;padding: 20px 15px;border-radius: 3px;">
					...
					<div class="margin10"></div>
						...
						<input type="text" required="required" name="project" class="form-control input" value="One Horizon Center" />
		...
		<div class="p-details">
			<div class="col-lg-8 col-md-6 col-sm-12">
				<h3>One Horizon Center Overview</h3>
				<div>
				   <p>One Horizon Center is destined to become the center of gravity for business in the heart of Gurgaon.</p><p>Developed by international real estate firm<span data-fr-verified="true">&nbsp;</span><strong>Hines</strong><span data-fr-verified="true">&nbsp;</span>and India's<span data-fr-verified="true">&nbsp;</span><strong>DLF Ltd.</strong><span data-fr-verified="true">&nbsp;</span>and designed by world renowned<span data-fr-verified="true">&nbsp;</span><strong>Robert A. M Stern Architects</strong>, One Horizon Center brings a new and exciting image to this vibrant city</p><p>Its architecture is both grand and elegant, its technology, elevators and safety systems are international quality, and sustainable design has been incorporated into every detail.</p><p>Rising majestically 25 stories above the 11-acre site across the Arnold Palmer-designed DLF Golf &amp; Country Club- one of the last remaining commercial tracts on Golf-Course Road- One Horizon Center is surrounded by everything a business desires.</p><p>Fortune 500 headquarters, fashionable residences, sleek shopping malls, stylish restaurants, and luxury hotels are all within walking distance.</p><p>Adding to its stature as an international office address, One Horizon Center will be the iconic architectural centerpiece of a prominent new mixed-use development, Horizon Center, comprising of office towers, retail amenities, and spectacular public plazas.</p> 
				</div>
			</div>
						<div class="col-lg-4 col-md-6 col-sm-12">
				<h3><i class="fas fa-map-marker"></i> Location Map</h3>
				<div>
					<img src="list/one-horizon-center-gurgaon/location-big2.jpg" class="site-plan" alt="" />
				...
				<div>
					<img src="list/one-horizon-center-gurgaon/master-plan-big.jpg" class="site-plan" alt="" />
				</div>
			</div>
				...
				<div>
					<ul>
  <li><p>High-Performance Facade</p></li>
  
  <li><p>Advanced Air-Conditioning</p></li>
  
  <li><p>Optimum Leasing Depth</p></li>
  
  <li><p>Higher Finished Ceiling</p></li>
  
  <li><p>Efficient Elevatoring System</p></li>
  
  <li><p>Well-Planned Security</p></li>
</ul> 
				</div>
			</div>
			        </div>
