...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=godrej-habitat-sector-3-gurgaon by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:31 GMT -->
    	...
    	<div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            	<ul class="bc-ul">
                    ...
                    <li><a href="residential-projects.html">Residential</a></li>
					<li><a href="#">/</a></li>
                    <li><a href="#" class="activebc">Godrej Habitat</a></li>
                </ul>
	...
	<div class="container">
        ...
        <div class="row">            
            ...
            <div class="details-header">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h2 class="">Godrej Habitat</h2>
					<div class="margin20" ></div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="details">
                        <div class="details center-block">
							<img src="list/godrej-habitat-sector-3-gurgaon/godrej-habitat-logo.png" class="project-logo " style="max-width: 200px;"  alt="" />          
						</div>                        
                    </div>
                </div>
				<div class="col-lg-4 col-md-4 col-sm-12">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 f-list">
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	
								<p class=""><i class="far fa-building"></i> Unit Type:- 2, 3 & 4 BHK Premium Homes</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	                		
								<p class=""><i class="fa fa-cubes" aria-hidden="true"></i> Size:- On Request</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
					...
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">
								<p class=""><i class="fa fa-map-marker" aria-hidden="true"></i> Location:- Sector 3, Gurgaon</p>                        
							</div>                        
						</div>
					</div>
				</div>
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    <div class="details">
                        <img src="list/godrej-habitat-sector-3-gurgaon/upld_552388983804839133_Godrejhabitatfb.jpg" class="project-banner" alt="Godrej Habitat" width="100%"  />
                ...
                <div class="col-lg-4 col-md-4 col-sm-12" style="background-color: #e8e8e8;padding: 20px 15px;border-radius: 3px;">
					...
					<div class="margin10"></div>
						...
						<input type="text" required="required" name="project" class="form-control input" value="Godrej Habitat" />
		...
		<div class="p-details">
			<div class="col-lg-8 col-md-6 col-sm-12">
				...
				<div>
					<img src="list/godrej-habitat-sector-3-gurgaon/upld_552387745229839939_117.jpg" class="site-plan" alt="" />
				</div>
			</div>
				...
				<div>
					<ul>
<li>Automated Boom Barrier</li>
<li>Bollards at entrance exit</li>
<li>Perimeter Fencing (Iron Spirals on top of walls with low voltage)</li>
<li>Laser Beam Security throughout the periphery of the project</li>
<li>CCTV Surveillance-Visual Check</li>
<li>Smart Vehicle Management System</li>
<li>IP based CCTV Camera</li>
<li>Night Guard Vigilance with Biometric monitoring</li>
<li>Mobile Application Security</li>
<li>Dog Patrolling on the periphery of the project</li>
<li>Under Car Scanner</li>
<li>Life Guard at Swimming Pool</li>
<li>Club Access Security-Face detection for access Control</li>
<li>Lobby Security: Face detection for access Control</li>
<li>CCTV in lower lobby for each floor</li>
<li>Smart delivery boxes</li>
<li>Pass Code Access</li>
<li>4 in 1 Smart door lock biometric code / Card / Key Access</li>
<li>Burglar Alarm</li>
<li>Smart Video</li>
<li>Geo Tags For Kids</li>
<li>Elderly Friendly Bathroom</li>
<li>Personal Medical Alert System Button</li>
<li>Anti Skid tiles in toilets</li>
</ul> 
				</div>
			</div>
			        </div>
...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=godrej-habitat-sector-3-gurgaon by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:32 GMT -->
</html>