...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=elan-miracle by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:41 GMT -->
    	...
    	<div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            	<ul class="bc-ul">
                    ...
                    <li><a href="commercial.html">Commercial</a></li>
					<li><a href="#">/</a></li>
                    <li><a href="#" class="activebc">Elan Miracle</a></li>
                </ul>
...
<article class="">
	<div class="container">
        ...
        <div class="row">            
            ...
            <div class="details-header">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h2 class="">Elan Miracle</h2>
					<div class="margin20" ></div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="details">
                        <div class="details center-block">
							<img src="list/elan-miracle/miracle-logo.png" class="project-logo " style="max-width: 200px;"  alt="" />          
						</div>                        
                    </div>
                </div>
				<div class="col-lg-4 col-md-4 col-sm-12">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 f-list">
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	
								<p class=""><i class="far fa-building"></i> Unit Type:- Retail, Office Spaces, Studio Apartments</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	                		
								<p class=""><i class="fa fa-cubes" aria-hidden="true"></i> Size:- 7 acres</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    <div class="details">
                        <img src="list/elan-miracle/elan.jpg" class="project-banner" alt="Elan Miracle" width="100%"  />
                ...
                <div class="col-lg-4 col-md-4 col-sm-12" style="background-color: #e8e8e8;padding: 20px 15px;border-radius: 3px;">
					...
					<div class="margin10"></div>
						...
						<input type="text" required="required" name="project" class="form-control input" value="Elan Miracle" />
		...
		<div class="p-details">
			<div class="col-lg-8 col-md-6 col-sm-12">
				<h3>Elan Miracle Overview</h3>
				<div>
				   <p>Elan since its inception, stood for –‘Building the future’. The group along with its collaborated undertaking- K&amp;T and ATF infrastructure, has recognized the potential of the Indian realty sector &amp; look forward to contributing in its growth through ultra luxury and cost effective residential, commercial and hospitality properties. Through wide ranging expertise, it offers unique projects, pricing and services exclusively to its clients.</p><p>Since inception, we are persistently focused on continuing to create and build spaces that can transform lives for a better tomorrow and a better world around us. Company has strong presence in northern India, Especially Delhi / NCR, with projects at the best locations of tier 1 cities.</p> 
				</div>
			</div>
						<div class="col-lg-4 col-md-6 col-sm-12">
				<h3><i class="fas fa-map-marker"></i> Location Map</h3>
				<div>
					<img src="list/elan-miracle/locationmap.jpg" class="site-plan" alt="" />
				...
				<div>
					<img src="list/elan-miracle/elan-miracle.jpg" class="site-plan" alt="" />
				</div>
			</div>
				...
				<div>
					<ul><li><p>14 Lacs sq.ft. of salable area
</p></li><li><p>Located on 135 mtrs. multi-utility corridor
</p></li><li><p>Fully Furnished Plug and Play Studio Apartments with fully loaded gym, spa, swimming pool etc.
</p></li><li><p>Well connected to CPR, SPR, ISBT &amp; International Airport
</p></li><li><p>7 acres project with 2.5 acres of landscaping &amp; water boddies all over
</p></li><li><p>Located amidst 50,000 residential units</p></li></ul> 
				</div>
			</div>
			        </div>
        </div>
