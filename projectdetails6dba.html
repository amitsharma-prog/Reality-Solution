...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=adani-samsara by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:43 GMT -->
    	...
    	<div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            	<ul class="bc-ul">
                    ...
                    <li><a href="residential-projects.html">Residential</a></li>
					<li><a href="#">/</a></li>
                    <li><a href="#" class="activebc">Adani Samsara</a></li>
                </ul>
...
<article class="">
	<div class="container">
        ...
        <div class="row">            
            ...
            <div class="details-header">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h2 class="">Adani Samsara</h2>
					<div class="margin20" ></div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="details">
                        <div class="details center-block">
							<img src="list/adani-samsara/logo.jpg" class="project-logo " style="max-width: 200px;"  alt="" />          
						</div>                        
                    </div>
                </div>
				<div class="col-lg-4 col-md-4 col-sm-12">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 f-list">
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	
								<p class=""><i class="far fa-building"></i> Unit Type:- 3/4 BHK Luxury Villa Floors</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	                		
								<p class=""><i class="fa fa-cubes" aria-hidden="true"></i> Size:- 18 Acres</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	
								<p class=""><i class="fa fa-cubes" aria-hidden="true"></i> Possession:- Oct 2020</p>                       
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">
								<p class=""><i class="fa fa-map-marker" aria-hidden="true"></i> Location:- Sector 60, Gurgaon</p>                        
							</div>                        
						</div>
					</div>
				</div>
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    <div class="details">
                        <img src="list/adani-samsara/adani.jpg" class="project-banner" alt="Adani Samsara" width="100%"  />
                ...
                <div class="col-lg-4 col-md-4 col-sm-12" style="background-color: #e8e8e8;padding: 20px 15px;border-radius: 3px;">
					...
					<div class="margin10"></div>
						...
						<input type="text" required="required" name="project" class="form-control input" value="Adani Samsara" />
		...
		<div class="p-details">
			<div class="col-lg-8 col-md-6 col-sm-12">
				<h3>Adani Samsara Overview</h3>
				<div>
				   <p>If you are looking for spacious villa floor for your cozy lifestyle with complete privacy then Adani Samsara is one the best dwelling area. Adani Samsara is one of the low-density projects which is spread over 18 acres of the land and is a prestigious part of the township which is over 145 acres. The project is well designed by international architect Woods Bagot. The project has come up with the innovative idea of a private residential floor which is located at Sector 60, Golf Course Road Extension.Harmony, Peace and Elegance are the redefined here. The project includes all the luxurious amenities along with the basic ones. The high street retails shopping center named as "The Inspire" and "The Belvedere" which is the super luxurious clubhouse with all modern sports and spa facilities are the most featured attraction of the place. The place is housed in a posh neighborhood. The Township comprises of a private independent floor with an exclusive terrace and a private basement. The complete project includes 222 units that are spread within 18 acres.</p> 
				</div>
			</div>
						<div class="col-lg-4 col-md-6 col-sm-12">
				<h3><i class="fas fa-map-marker"></i> Location Map</h3>
				<div>
					<img src="list/adani-samsara/samsaralocation.jpg" class="site-plan" alt="" />
				...
				<div>
					<img src="list/adani-samsara/master-plan.jpg" class="site-plan" alt="" />
				</div>
			</div>
				...
				<div>
					<ul>
  <li><p>Air-conditioned Villa Floors</p></li>

  <li><p>VRV Air Conditioning in Bedrooms &amp; Living Room</p></li>

  <li><p>Low Density 222 Units in 18 Acre</p></li>

  <li><p>Laminated wooden flooring in Bedrooms</p></li>

  <li><p>Premium Imported Marble Flooring</p></li>

  <li><p>Premium Modular Kitchen</p></li>

  <li><p>Ultra Luxury Club House</p></li>

  <li><p>Olympic Sized Swimming Pool</p></li>

  <li><p>One of the low-density Villa floors with only 222 units in 18 Acres</p></li>

  <li><p>Your own personal terrace &amp; basement</p></li>

  <li><p>Commercial complex &amp; Club House next door</p></li>

  <li><p>Fully Integrated Gated Community</p></li>
</ul> 
				</div>
			</div>
			        </div>
