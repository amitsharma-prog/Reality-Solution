...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=m3m-latitude by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:25 GMT -->
    	...
    	<div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            	<ul class="bc-ul">
                    ...
                    <li><a href="residential-projects.html">Residential</a></li>
					<li><a href="#">/</a></li>
                    <li><a href="#" class="activebc">M3M Latitude</a></li>
                </ul>
...
<article class="">
	<div class="container">
        ...
        <div class="row">            
            ...
            <div class="details-header">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h2 class="">M3M Latitude</h2>
					<div class="margin20" ></div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="details">
                        <div class="details center-block">
							<img src="list/m3m-latitude/project-logo-1.png" class="project-logo " style="max-width: 200px;"  alt="" />          
						</div>                        
                    </div>
                </div>
				<div class="col-lg-4 col-md-4 col-sm-12">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 f-list">
					...
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	                		
								<p class=""><i class="fa fa-cubes" aria-hidden="true"></i> Size:- 2.00 Acres</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	
								<p class=""><i class="fa fa-cubes" aria-hidden="true"></i> Possession:- April 2020</p>                       
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">
								<p class=""><i class="fa fa-map-marker" aria-hidden="true"></i> Location:- Golf Course Ext Rd, Sector 65, Gurgaon</p>                        
							</div>                        
						</div>
					</div>
				</div>
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    <div class="details">
                        <img src="list/m3m-latitude/M3M-LATITUDE-BANNER.jpg" class="project-banner" alt="M3M Latitude" width="100%"  />
                ...
                <div class="col-lg-4 col-md-4 col-sm-12" style="background-color: #e8e8e8;padding: 20px 15px;border-radius: 3px;">
					...
					<div class="margin10"></div>
						...
						<input type="text" required="required" name="project" class="form-control input" value="M3M Latitude" />
		...
		<div class="p-details">
			<div class="col-lg-8 col-md-6 col-sm-12">
				<h3>M3M Latitude Overview</h3>
				<div>
				   <p>As the name indicates - it is a concept which is upscale and sophisticated. The physical element of ‘height’ is strongly emphasized along with modernity and a certain “Techno- style”. This essentially connotes a neo-minimalist, futuristic design, evoking a sense of steel greys, cool water, blocks and avant-garde sculptures.</p><p>The landscaping will evoke a sense of a closely cropped garden. Well lit with mood effects and rock-garden features with in-built audio speakers. The whole scenario will incorporate pebbled pathways leading to the exclusive club and infinity pool.</p><p>The highlight of the tower would be the roof-top lounge and  360° observatory circle- culminating in a rectangular penultimate top.</p><p>A truly unique, singular tower overlooking the skyline of the modern millennium city – Gurgaon.</p><p>Exceptional location. Exceptional architecture. Exceptional life!</p> 
				</div>
			</div>
						<div class="col-lg-4 col-md-6 col-sm-12">
				<h3><i class="fas fa-map-marker"></i> Location Map</h3>
				<div>
					<img src="list/m3m-latitude/latitude.png" class="site-plan" alt="" />
				...
				<div>
					<img src="list/m3m-latitude/540576245dc62site-plan.jpg" class="site-plan" alt="" />
				</div>
			</div>
				...
				<div>
					<ul>
  <li><p>162 limited edition units</p></li>
            
  <li><p>Modern Contemporary Architecture; Designed by UHA, London.</p></li>
            
  <li><p>Highly efficient architecture planning and design.</p></li>
            
  <li><p>High rise with beautiful external lighting in the building.</p></li>
            
  <li><p>All around, all apartments enjoy abundant natural light.</p></li>
            
  <li><p>World-class club with Gymnasium, Squash court, SPA, Jacuzzi, Steam, Sauna etc.</p></li>
            
  <li><p>Resort-style pool area and large deck. </p></li>
            
  <li><p>Every room in the apartment, living or bedroom has a balcony as per the new floor plan</p></li>
        </ul> 
				</div>
			</div>
			        </div>
