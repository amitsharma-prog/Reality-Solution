...
<!-- Mirrored from www.transactionpoint.in/careers.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:44 GMT -->
...
<!-- Window Load popup Ends Here-->
    	...
    	<div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            	<ul class="bc-ul">
                    ...
                    <li><a href="#">/</a></li>
                    <li><a href="#" class="activebc">Careers</a></li>
                </ul>
	...
	<div class="container  ">
		<img src="images/career-banner.png" alt="" style="width:100%" />
    	<div class="col-lg-8 col-md-6 col-sm-12 gap  ">
        	<h3 class="heading-main">Get Your Job Position !</h3>
        	<form class="forms" action="#" method="post" >
            	<input type="text" required="required" name="name" placeholder="Enter your name..." class="form-control input" />
                
                <input type="email" required="required" name="email" placeholder="Enter your email..." class="form-control input"/>
                <input type="number" required="required" name="contact" placeholder="Enter your contact no..." class="form-control input" />
                <input type="text" required="required" name="subject" placeholder="Enter your Job Description..." class="form-control input" />
                <textarea rows="5" placeholder="Enter your profile Details..." name="message" required class="form-control"></textarea>
                
                <input type="submit" name="submit" value="Submit" class="b2" /> 
                
            </form>
    	</div>
		<div class="col-lg-4 col-md-6 col-sm-12 ">     	
			<h4 class="head"><button class="sc glyphicon glyphicon-home"></button><span class="heads">Contact Details</span></h4> 
            <p class="c">410 & 411, Emaar Digital Greens,
			<br />Golf Course Extn Road, Sector 61,<br />Gurgaon Haryana 122001</p>
			<p  class="c" >+91-9911052355/9650457788</p>
			<p class="c">care@transactionpoint.in <br /> transactionpoint@yahoo.in</p>
...
<!-- Mirrored from www.transactionpoint.in/careers.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:45 GMT -->
</html>