...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=M3M-ifc by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:22 GMT -->
    	...
    	<div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            	<ul class="bc-ul">
                    ...
                    <li><a href="commercial.html">Commercial</a></li>
					<li><a href="#">/</a></li>
                    <li><a href="#" class="activebc">M3M IFC | M3M International Financial Center</a></li>
                </ul>
...
<article class="">
	<div class="container">
        ...
        <div class="row">            
            ...
            <div class="details-header">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h2 class="">M3M IFC | M3M International Financial Center</h2>
					<div class="margin20" ></div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="details">
                        <div class="details center-block">
							<img src="list/M3M-ifc/ifc-logo.png" class="project-logo " style="max-width: 200px;"  alt="" />          
						</div>                        
                    </div>
                </div>
				<div class="col-lg-4 col-md-4 col-sm-12">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 f-list">
					...
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">    	                		
								<p class=""><i class="fa fa-cubes" aria-hidden="true"></i> Size:- 4.6 Acres</p>                    
							</div>                        
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-12">
					...
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="details">
							<div class="details center-block ">
								<p class=""><i class="fa fa-map-marker" aria-hidden="true"></i> Location:- Golf Course Ext Rd, Sector 66, Gurgaon</p>                        
							</div>                        
						</div>
					</div>
				</div>
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    <div class="details">
                        <img src="list/M3M-ifc/ifc-banner.jpg" class="project-banner" alt="M3M IFC | M3M International Financial Center" width="100%"  />
                ...
                <div class="col-lg-4 col-md-4 col-sm-12" style="background-color: #e8e8e8;padding: 20px 15px;border-radius: 3px;">
					...
					<div class="margin10"></div>
						...
						<input type="text" required="required" name="project" class="form-control input" value="M3M IFC | M3M International Financial Center" />
		...
		<div class="p-details">
			<div class="col-lg-8 col-md-6 col-sm-12">
				<h3>M3M IFC | M3M International Financial Center Overview</h3>
				<div>
				   <p>As a prominent mixed-use destination in Gurugram, M3M IFC includes two landmark towers, as an amalgamation of premium 'grade A' of&#64257;ces and a wide variety of luxury retail spaces. With its sophisticated building plan, it provides the perfect balance and &#64258;exibility to stay competitive. The master plan is highly permeable for pedestrians, with the design conceived as a point of connection between work and leisure.</p><ul><li><p><span data-fr-verified="true" style="color: #000000;">Approx. 1.8 hectares (4.6 acres). of premium site</span></p></li><li><p><span data-fr-verified="true" style="color: #000000;">An approx. 93,000 sq mtr. (million sq. ft.) of project out of which around 1,39,35 sq. mtr. (1.5 lac sq. ft.) is premium retail</span></p></li><li><p><span data-fr-verified="true" style="color: #000000;">Designed by Chapman Taylor</span></p></li><li><p><span data-fr-verified="true" style="color: #000000;">Unmatched Facilities</span></p></li></ul> 
				</div>
			</div>
						<div class="col-lg-4 col-md-6 col-sm-12">
				<h3><i class="fas fa-map-marker"></i> Location Map</h3>
				<div>
					<img src="list/M3M-ifc/location.jpg" class="site-plan" alt="" />
				...
				<div>
					<img src="list/M3M-ifc/floor1.jpg" class="site-plan" alt="" />
				</div>
			</div>
...
<!-- Mirrored from www.transactionpoint.in/projectdetails.php?projectname=M3M-ifc by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2019 11:06:23 GMT -->
</html>